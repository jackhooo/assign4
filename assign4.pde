...
void setup () {
  size(640,480);
  background(255);
  boom1 = loadImage("img/flame1.png");
  boom2 = loadImage("img/flame2.png");
  boom3 = loadImage("img/flame3.png");
  boom4 = loadImage("img/flame4.png");
  boom5 = loadImage("img/flame5.png");
...
void draw() {
  ...
  {     
    ...
    if(disappear[x] == 1)
    {frameRate(1);
     boomx=exarray[x];boomy=eyarray[x];
     image(boom1,boomx,boomy);
     frameRate(60);
    }
    if(disappear[x] == 1)
    {frameRate(1);
     boomx=exarray[x];boomy=eyarray[x];
     image(boom2,boomx,boomy);
     frameRate(60);
    }
    if(disappear[x] == 1)
    {frameRate(1);
     boomx=exarray[x];boomy=eyarray[x];
     image(boom3,boomx,boomy);
     frameRate(60);
    }
    if(disappear[x] == 1)
    {frameRate(1);
     boomx=exarray[x];boomy=eyarray[x];
     image(boom4,boomx,boomy);
     frameRate(60);
    }
    if(disappear[x] == 1)
    {frameRate(1);
     boomx=exarray[x];boomy=eyarray[x];
     image(boom5,boomx,boomy);
     frameRate(60);
    }
